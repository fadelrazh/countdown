  ...
  return (
    <div>
      <div className="relative perspective">
        ...
        >
          <p className="absolute top-5 lg:top-8 left-0 right-0 text-center text-blue-400 text-4xl lg:text-8xl font-bold">
        ...
        >
          <p className="absolute bottom-5 lg:bottom-8 left-0 right-0 text-center text-blue-800 text-4xl lg:text-8xl font-bold" data-testid={id}>
        ...
        { previous !== current &&
          <>
            ...
            >
              <div className="relative h-10 lg:h-20">
                <p className="absolute bottom-5 lg:bottom-8 left-0 right-0 text-center text-blue-800 text-4xl lg:text-8xl font-bold">
                  {typeof current === 'undefined' ? '' : padStart(current)}
                </p>
                <svg width="100%" height="100%">
